...
The repository is public, so no token is needed — see [deploy/README.md](deploy/README.md)
if you want one anyway, for the higher rate limit or in case it goes private again.
